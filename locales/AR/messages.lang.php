...
$GLOBALS['__l10n']["create table"]="إنشاء جدول";
...
$GLOBALS['__l10n']["Edit group class"]="تعديل الصنف مجموعة";
...
$GLOBALS['__l10n']["Related tests"]="الاختبارات ذات الصلة";
...
$GLOBALS['__l10n']["Select group deliveries"]="Choissiez les deliveries du groupe";
$GLOBALS['__l10n']["Select group test takers"]="اختر مواضيع المجموعة";
...
$GLOBALS['__l10n']["The main objective of the Group module is to assign the test(s) to the appointed group, thus establishing the basis for running a test."]="L'objectif principal du module Groupe est d'attribuer le(s) test(s) au groupe désigné, en établissant ainsi la base de l'exécution du test.";
