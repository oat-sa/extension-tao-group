...
$GLOBALS['__l10n']["Edit group class"]="Redigera gruppklass";
...
$GLOBALS['__l10n']["Group saved"]="Grupp sparad";
...
$GLOBALS['__l10n']["Related tests"]="Besläktade test";
...
$GLOBALS['__l10n']["Select group deliveries"]="Välj gruppleveranser";
$GLOBALS['__l10n']["Select group test takers"]="Välj grupptesttagare";
...
$GLOBALS['__l10n']["The main objective of the Group module is to assign the test(s) to the appointed group, thus establishing the basis for running a test."]="Huvudsyftet med gruppmodulen är att knyta test(er) till fastställd grupp, och därigenom upprätta grunden för att genomföra ett test";
