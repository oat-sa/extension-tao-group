...
describe('Groups Page', () => {
    ...
    describe('Groups page', () => {
        it('should be Groups menu button', function () {
            cy.get('nav ul.main-menu li.active a span.icon-test-takers').should('have.length', 1);
        });

        it('should be left panel with Groups tree', function () {
            cy.get('div.taotree-group').find('ul').children().should('not.to.have.length', 0);
        });
