...
(8, 'http://127.0.0.1/middleware/demo.rdf#i125240126564680', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 'http://www.tao.lu/Ontologies/TAOGroup.rdf#Group', '', 'generis', 'yyy[admin,administrators,authors]', 'yyy[admin,administrators,authors]', 'yyy[admin,administrators,authors]'),
(8, 'http://127.0.0.1/middleware/demo.rdf#i125240126564680', 'http://www.w3.org/2000/01/rdf-schema#label', 'My group', '', 'demo', 'yyy[admin,administrators,authors]', 'yyy[admin,administrators,authors]', 'yyy[admin,administrators,authors]'),
